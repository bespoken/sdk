...
![<img src="docs/images/pinoJs.png" width="50%">](docs/images/pinoJs.png)
...
![<img src="docs/images/pinoJsColorized.png" width="50%">](docs/images/pinoJsColorized.png)

Finally, we can add timestamps to the outputs by setting the env variable `DISPLAY_LOG_TIME`.

![<img src="docs/images/pinoJsTimestamp.png" width="50%">](docs/images/pinoJsTimestamp.png)
